package com.pharid.splash.lib.activity;
...
import com.pharid.splash.lib.R;
import com.pharid.splash.lib.cnst.Flags;
import com.pharid.splash.lib.model.ConfigSplash;
import com.pharid.splash.lib.utils.UIUtil;
import com.pharid.splash.lib.utils.ValidationUtil;

import io.codetail.animation.SupportAnimator;
import io.codetail.animation.ViewAnimationUtils;

abstract public class AnimatedSplash extends AppCompatActivity {
    ...
    public void startLogoAnimation() {
        ...
        YoYo.with(mConfigSplash.getAnimLogoSplashTechnique()).withListener(new android.animation.Animator.AnimatorListener() {
            @Override
    ...
    public void startTextAnimation() {
        ...
        YoYo.with(mConfigSplash.getAnimTitleTechnique()).withListener(new android.animation.Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(android.animation.Animator animation) {
